...
def add_model_options(parser):
    ...
    parser.add_argument('--init_emb', type=str, choices=['random', 'learned'], default='random', help='Embedding initialization')
    ...
    parser.add_argument('--n_iterations', type=int, default=10, help='Number of rounds of message passing')
